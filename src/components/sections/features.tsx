          ...
          {features.map((feature) => (
            <div className={`rounded-[var(--radius-lg)] p-6 shadow-[var(--shadow-sm)] ${feature.accent}`} key={feature.title}>
              ...
              <div className="mt-6 flex items-center justify-center">
                <div className="relative h-16 w-16 overflow-hidden rounded-3xl bg-[rgba(255,255,255,0.14)]">
                  <img
                    alt={`${feature.title} Icon`}
                    className="absolute left-0 top-0 h-[300%] max-w-none w-[300%]"
                    src="/graphics/feature-icons.png"
                    style={{ transform: `translate(-${feature.sprite.x}, -${feature.sprite.y})` }}
                  />
                </div>
              </div>
